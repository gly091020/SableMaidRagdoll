package com.gly091020.SableMaidRagdoll.maid.tlm.client.renderer;
...
import com.gly091020.SableMaidRagdoll.maid.tlm.util.TLMMaidModelHelper;
import com.gly091020.SableMaidRagdoll.maid.tlm.util.RagdollChatBubbleRenderer;
    ...
    public void renderMain(MaidPartBlockEntity blockEntity, float delta, PoseStack poseStack, MultiBufferSource multiBufferSource, int light, int overlay) {
        ...
        for (var renderPart : cache.parts(data.partName(), data.renderData().parts())) {
            if (renderPart.flatChild()) {
                TLMMaidModelHelper.renderBedrockPartsWithFlat(renderPart.part(), poseStack, vc, light, overlay);
            } else {
                TLMMaidModelHelper.renderBedrockPart(renderPart.part(), poseStack, vc, light, overlay);
            }
        }
