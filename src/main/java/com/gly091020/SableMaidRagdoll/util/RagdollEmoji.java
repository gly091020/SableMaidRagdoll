...
public final class RagdollEmoji {
    ...
    public static boolean hasEmoji(Player player) {
        return !getEmoji(player).equals(InitAttachmentTypes.EMPTY_EMOJI);
    }
    ...
    public static ResourceLocation getEmoji(Player player) {
        return player.getData(InitAttachmentTypes.EMOJI_ATTACHMENT.get());
    }
    ...
    public static void setEmoji(Player player, @Nullable ResourceLocation location) {
        player.setData(InitAttachmentTypes.EMOJI_ATTACHMENT.get(), location == null ? InitAttachmentTypes.EMPTY_EMOJI : location);
    }
}
